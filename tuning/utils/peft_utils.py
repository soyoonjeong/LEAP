...
def create_and_prepare_model(
    ...
    if script_args.use_dora == True:
    ...
    elif script_args.use_rslora == True:
        print("rsLoRA Init")
        peft_config = LoraConfig(
            use_rslora=True,
            lora_alpha=int(16 * (script_args.lora_r**0.5)),
            lora_dropout=script_args.lora_dropout,
            r=script_args.lora_r,
            bias="none",
            task_type="CAUSAL_LM",
        ...
        print("LoRA Init")
        if script_args.lora_alpha == 0:
            script_args.lora_alpha = script_args.lora_r * 2
    ...
    tokenizer.model_max_length = script_args.tokenizer_model_max_length
